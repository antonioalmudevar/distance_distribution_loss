...
class PredefinedPrototypesAttributesModel(BaseClassifier):
    ...
    def __init__(
        ...
        self.proto_loss = PredefinedPrototypesAttributesLoss(
...
class PredefinedPrototypesAttributesLoss(nn.Module):
